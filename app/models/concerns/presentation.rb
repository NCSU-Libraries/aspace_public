module Presentation
  ...
  class Presenter
    ...
    attr_accessor :data, :record, :title, :uri, :level, :position, :resource_id, :component_id,
      ...
      :total_components, :subjects, :agents, :digital_objects, :alt_digital_object_url
    ...
    # Convenience method that allows has_digital_object to be called on the record via the Presnter
